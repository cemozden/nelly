...
function FeedCategoryAPI(express, configManager) {
    var _this = this;
    express.get('/getrootcategory', function (req, res) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (categoryAdded) {
                        Logger_1.default.info("[AddFeedCategory] A new feed category added! New Category : " + JSON.stringify(feedCategory));
                        res.json({ added: true, categoryObject: feedCategory, rootCategory: feedConfigManager.getRootCategory() });
                    }
                    else {
                        Logger_1.default.error("[AddFeedCategory] An error occured while adding the category! Request Params: " + JSON.stringify(params));
    ...
    express.get('/updatefeedcategory', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var params, categoryId, categoryName, visible, errorMessage, errorMessage, feedConfigManager, oldFeedCategory, updatedFeedCategory, categoryUpdated, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    params = req.query;
                    ...
                    feedConfigManager = configManager.getFeedConfigManager();
                    oldFeedCategory = FeedConfigManager_1.getCategoryById(categoryId, feedConfigManager.getRootCategory());
                    updatedFeedCategory = {
                ...
                case 2:
                    ...
                    if (categoryUpdated) {
                        Logger_1.default.info("[UpdateFeedCategory] A category is updated successful. Old version: " + JSON.stringify(oldFeedCategory) + " New Version: " + JSON.stringify(updatedFeedCategory));
                        res.json({ updated: true, categoryObject: updatedFeedCategory, rootCategory: feedConfigManager.getRootCategory() });
                    }
                    else {
                        Logger_1.default.error("[UpdateFeedCategory] An error occured while updating the category!, Request Params: " + JSON.stringify(params));
     ...
     * categoryId : string
     */
    express.get('/deletefeedcategory', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var params, categoryId, errorMessage, feedConfigManager, feedCategoryToDelete, categoryDeleted, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    params = req.query;
                    ...
                    if (categoryId === undefined || categoryId.length === 0) {
                        ...
                        Logger_1.default.error("[DeleteFeedCategory] " + errorMessage + ", Request params: " + JSON.stringify(params));
                        return [2 /*return*/];
                    }
                    feedConfigManager = configManager.getFeedConfigManager();
                    feedCategoryToDelete = FeedConfigManager_1.getCategoryById(categoryId, feedConfigManager.getRootCategory());
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, feedConfigManager.deleteFeedCategory(categoryId)];
                case 2:
                    categoryDeleted = _a.sent();
                    if (categoryDeleted) {
                        Logger_1.default.info("[DeleteFeedCategory] A feed category with the id \"" + categoryId + "\" deleted!, Data: " + JSON.stringify(categoryDeleted));
                        res.json({ deleted: true, deletedCategory: feedCategoryToDelete, rootCategory: feedConfigManager.getRootCategory() });
                    }
                    else {
                        Logger_1.default.error("[DeleteFeedCategory] An error occured while deleting the category with the id \"" + categoryId + "\"! ");
                        res.json({ deleted: false, message: 'An error occured while deleting the category!' });
                    }
                    return [3 /*break*/, 4];
                case 3:
                    err_3 = _a.sent();
                    Logger_1.default.error("[DeleteFeedCategory] " + err_3.message + ", Request Params: " + JSON.stringify(params));
...
exports.default = FeedCategoryAPI;
//# sourceMappingURL=FeedCategoryAPIs.js.map